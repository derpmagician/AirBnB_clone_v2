...
class TestConsole(unittest.TestCase):
    ...
    def test_create(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            self.assertEqual(
                "** class name missing **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("create goku")
            self.assertEqual(
                "** class doesn't exist **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_update(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            self.assertEqual(
                "** class name missing **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("update luffy")
            self.assertEqual(
                "** class doesn't exist **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_alter_count(self):
        """Test count command input"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("goku.count()")
            self.assertEqual(
                "** class doesn't exist **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_alter_show(self):
        """Test alternate show command input"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("gilgamesh.show()")
            self.assertEqual(
                "** class doesn't exist **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_update(self):
        """Test alternate destroy command inout"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("luffy.update()")
            self.assertEqual(
                "** class doesn't exist **\n", f.getvalue())
        with patch('sys.stdout', new=StringIO()) as f:
